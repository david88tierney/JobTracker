...
<div class="navbar">
  ...
  <div class="logout">
  	<a href="/deleteSession"> Logout</a>
        ...
        <p><form:label path="company"> Company: </form:label></p>
		<p><form:errors path="company"></form:errors> </p>
        <p><form:input path="company"></form:input></p>
